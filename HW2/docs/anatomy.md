...
| Условие | Значение |
|---|---|
| платформа | macOS-26.4-arm64-arm-64bit (Darwin 25.4.0, arm64) |
| устройство | `mps` |
| dtype | `bfloat16` |
| seq_len × batch | 256 × 1 |
| прогонов на режим | 1 |
...
|---|--:|--:|--:|--:|--:|
| инференс | 7696 | 7914 | 1.00 | 3.6 | — |
| full fine-tune | 20318 | 11229 | 2.64 | 7.7 | 13.6807 |
| LoRA (r=8, q/v) | 8871 | 11229 | 1.15 | 7.5 | 13.6807 |
...
Колонка «Пик RSS» между режимами почти не меняется: разброс 3315 МБ на все три — и это при том, что full fine-tune обязан добавить к весам ещё 9845 МБ.
...
После правок: inference 7696 / LoRA 8871 / full FT 20318 МБ.
